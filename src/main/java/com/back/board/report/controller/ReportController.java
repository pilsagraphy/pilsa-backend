...
public class ReportController {
    ...
    @Operation(summary = "게시글/댓글 신고 접수",
            description = """
                    ...
                    - detail 은 사유가 '기타'(code=ETC)일 때만 저장된다. **서버가 정리한다** —
                      기타가 아닌 사유로 detail 이 와도 400 이 아니라 서버가 버리고 접수한다
                      (사유를 바꿀 때 입력칸을 비울 책임을 프론트에 떠넘기지 않는다).
                      기타인데 비어 있을 때만 400 이다(공백만 있으면 미입력으로 본다).
